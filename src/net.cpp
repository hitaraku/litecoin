...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Hitacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"hitacointools.com", "dnsseed.hitacointools.com"},
    {"hitacoinpool.org", "dnsseed.hitacoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"hitacointools.com", "testnet-seed.hitacointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Hitacoin is probably already running."), addrBind.ToString().c_str());
        else
